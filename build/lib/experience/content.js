export const clientProjects = [
    {
        ...
        description: 'A comprehensive platform helping students compare 10,000+ colleges and universities',
        outcomes: [
        ...
        results: 'Empowering students to make informed decisions about their education with fast, reliable data'
    },
    {
        name: 'Inkwell',
        tagline: 'Academic Publishing Platform - AI & Infrastructure',
        description: 'Marketing pages, AI chatbot, administrative tools, and custom MCP server for an academic writing platform',
        outcomes: [
        ...
        results: 'Supporting an academic writing platform with intelligent assistance and seamless user experience'
    },
    {
        name: 'Inkwell Press & Studio',
        tagline: 'Publishing Platform Suite',
        description: 'A complete publishing ecosystem with multiple applications and shared component library',
        outcomes: [
        ...
        results: 'Enabling rapid development and consistent quality across multiple publishing applications'
    },
    {
        name: 'Success Portraits',
        tagline: 'Career Assessment Platform',
        description: 'An AI-powered personality assessment platform with custom licensing system and MCP server',
        outcomes: [
        ...
        results: 'Helping individuals discover career paths with enterprise-grade licensing and AI analysis'
    },
    {
        name: 'Nuisiout',
...
export const projects = [
    ...
    },
    {
        ...
        description: 'Complete publishing platform suite including Inkwell Press, Inkwell Studio, and shared component library',
        features: [
        ...
        results: 'Unified ecosystem enabling consistent UX and faster development across all Inkwell properties',
    ...
    },
    {
        ...
        description: 'AI-powered assessment platform with custom licensing system, MCP server, and headless WordPress',
        features: [
...
export const clientServices = [
    {
        ...
        longDescription: 'Hand-coded websites built for your business—no templates, no page builders. Fast, works on every device, and flexible enough to add features as you grow.',
        lucide_icon: 'code',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Chatbots that answer customer questions, tools that generate content, automation that runs while you sleep. Practical AI, not buzzword AI.',
        lucide_icon: 'brain',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Connect your apps and automate the repetitive stuff. Social media posting, data syncing, email sequences—workflows that run in the background.',
    ...
    },
    {
        ...
        longDescription: 'Edit text, swap images, publish content—all from a dashboard. No developer needed for day-to-day updates.',
    ...
    },
    {
        ...
        longDescription: 'One codebase, both app stores. Native performance, offline support, push notifications. We handle submission too.',
    ...
    },
    {
        ...
        longDescription: 'Secure payments, checkout that converts. Products, subscriptions, services—with inventory management and fraud protection.',
    ...
    },
    {
        ...
        longDescription: "Websites that speak your customers' languages. Local SEO, localized content, currency, and date formats—managed from one dashboard.",
    ...
    },
    {
        ...
        longDescription: 'Portals, assessments, and analytics for academic institutions. Integrated with federal education data for real outcomes.',
    ...
    },
    {
        ...
        longDescription: 'Enterprise plugins, headless setups, and WooCommerce stores. Full control with easy content updates.',
        lucide_icon: 'blocks',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Clear analytics, conversion tracking, audience segmentation. Plus automated email campaigns that actually get opened.',
    ...
    },
    {
        ...
        longDescription: 'Your site stays fast whether you have ten visitors or ten thousand. Optimized code, smart caching, auto-scaling infrastructure.',
        lucide_icon: 'gauge',
        benefits: [
