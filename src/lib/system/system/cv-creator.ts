...
2. Call get_cv for structure and experience responsibilities
...
- experiences: exactly 4 items, each with exactly 4-5 responsibilities (no more), ordered by years (IMPORTANT: most recent first)
...
- Responsibilities per experience: exactly 3-4 bullets (not 5)
